...
PYTHON_DARKNET YOLOClass *init(bool verbose, bool quiet)
{
    YOLOClass *detector = new YOLOClass(verbose, quiet);
    return detector;
}


PYTHON_DARKNET void train(YOLOClass *detector, char *train_pos_chip_path,
...
PYTHON_DARKNET void detect(YOLOClass *detector, CRForest *forest,
                                 ...
                                 int RESULT_LENGTH, bool serial, bool verbose, bool quiet)
{
    ...
    if( ! quiet )
    {
        ...
        if(serial)
        {
            cout << "[pydarknet c] Detecting images parallelized across scales" << endl;
        }
        else
        {
            cout << "[pydarknet c] Detecting images parallelized across batch" << endl;
        }
    }
